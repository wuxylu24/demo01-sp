...
import com.shp.demo.common.security.component.ShpWebResponseExceptionTranslator;
import com.shp.demo.common.security.config.JwtTokenEnhancer;
import com.shp.demo.common.security.properties.ShpSecurityProperties;
import com.shp.demo.common.security.service.ShpClientDetailsService;
...
public class ShpAuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {

    @Autowired
    private ShpUserDetailService sphUserDetailService;
    @Autowired
    ...
    @Autowired
    private ShpClientDetailsService sphClientDetailsService;
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.withClientDetails(sphClientDetailsService);
    }
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        endpoints.authenticationManager(authenticationManager)
                .userDetailsService(sphUserDetailService)
        ...
        // ;  //自定义异常处理
                .exceptionTranslator(new ShpWebResponseExceptionTranslator());
    }
