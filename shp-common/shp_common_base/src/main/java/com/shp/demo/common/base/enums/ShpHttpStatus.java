package com.shp.demo.common.base.enums;

import lombok.Getter;

@Getter
public enum ShpHttpStatus {
    /**
    ...
    ShpHttpStatus(Integer code, String message) {
        this.code = code;
     ...
     * @return the enum
     */
    public static ShpHttpStatus getEnum(int code) {
        for (ShpHttpStatus ele : ShpHttpStatus.values()) {
            if (ele.getCode() == code) {
                return ele;
            }
        }
